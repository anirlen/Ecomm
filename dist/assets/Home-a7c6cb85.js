import{j as e,r as b,R as v}from"./index-33abfec6.js";import{s as t,c as S,A as k,N as $}from"./Navbar-98f9e5b1.js";import{S as L,T as r,C as a,B as l,s as C,j as E,a as M,b as z,c as T,d as W,e as A}from"./shirt3-67eaa129.js";import{C as I,O as B,G as q}from"./GLTFLoader-a2747bba.js";const R=t.div`
  width: 100%;
  display: flex;
...
`,h=t(T)`
  width: auto;
`,O=()=>e.jsxs(R,{children:[e.jsx(D,{children:"New Arrivals"}),e.jsxs(N,{children:[e.jsxs(d,{sx:{maxWidth:300},children:[e.jsx(c,{src:L,alt:"Sweater"}),e.jsxs(h,{children:[e.jsx(r,{gutterBottom:!0,variant:"h5",component:"div",children:"Sweater"}),e.jsx(r,{variant:"body2",color:"text.secondary",children:"Warm and stylish sweater, perfect for cold winter days. Made from high-quality materials for maximum comfort."})]}),e.jsx(a,{children:e.jsx(l,{size:"small",children:"Learn More"})})]}),e.jsxs(d,{sx:{maxWidth:300},children:[e.jsx(c,{src:C,alt:"Sweater"}),e.jsxs(h,{children:[e.jsx(r,{gutterBottom:!0,variant:"h5",component:"div",children:"Shirt"}),e.jsx(r,{variant:"body2",color:"text.secondary",children:"Warm and stylish sweater, perfect for cold winter days. Made from high-quality materials for maximum comfort."})]}),e.jsx(a,{children:e.jsx(l,{size:"small",children:"Learn More"})})]}),e.jsxs(d,{sx:{maxWidth:300},children:[e.jsx(c,{src:E,alt:"Sweater"}),e.jsxs(h,{children:[e.jsx(r,{gutterBottom:!0,variant:"h5",component:"div",children:"Jeans"}),e.jsx(r,{variant:"body2",color:"text.secondary",children:"Warm and stylish sweater, perfect for cold winter days. Made from high-quality materials for maximum comfort."})]}),e.jsx(a,{children:e.jsx(l,{size:"small",children:"Learn More"})})]}),e.jsxs(d,{sx:{maxWidth:300},children:[e.jsx(c,{src:M,alt:"Sweater"}),e.jsxs(h,{children:[e.jsx(r,{gutterBottom:!0,variant:"h5",component:"div",children:"Jeans"}),e.jsx(r,{variant:"body2",color:"text.secondary",children:"Warm and stylish sweater, perfect for cold winter days. Made from high-quality materials for maximum comfort."})]}),e.jsx(a,{children:e.jsx(l,{size:"small",children:"Learn More"})})]})]})]}),U=S(e.jsx("path",{d:"m14 7-5 5 5 5V7z"}),"ArrowLeft"),G=S(e.jsx("path",{d:"m10 17 5-5-5-5v10z"}),"ArrowRight"),J=t.div`
  width: 100%;
  height: 100vh;
  display: flex;
  background-color: #FFFFFF;
...
`,H=()=>{const[i,n]=b.useState(0),o=m=>{n(m==="left"?s=>s===0?2:s-1:s=>s===2?0:s+1)};return e.jsxs(J,{children:[e.jsx(F,{direction:"left",onClick:()=>o("left"),children:e.jsx(U,{})}),e.jsxs(X,{style:{transform:`translateX(-${i*100}vw)`},children:[e.jsxs(y,{bg:"#FFFFFF",children:[e.jsx(p,{children:e.jsx(w,{src:C,alt:"Slide 1"})}),e.jsxs(g,{children:[e.jsx(u,{children:"Winter Sale"}),e.jsx(f,{children:"Excepteur dolor commodo ipsum sit dolore sint cupidatat quis in id sunt voluptate dolor pariatur."}),e.jsx(j,{children:"See More"})]})]}),e.jsxs(y,{bg:"#FFFFFF",children:[e.jsx(p,{children:e.jsx(w,{src:W,alt:"Slide 2"})}),e.jsxs(g,{children:[e.jsx(u,{children:"Spring Sale"}),e.jsx(f,{children:"BAmet ipsum commodo ullamco aute nulla Lorem nulla dolore veniam aute Lorem ad."}),e.jsx(j,{children:"See More"})]})]}),e.jsxs(y,{bg:"#FFFFFF",children:[e.jsx(p,{children:e.jsx(w,{src:A,alt:"Slide 3"})}),e.jsxs(g,{children:[e.jsx(u,{children:"Fall Sale"}),e.jsx(f,{children:"Cupidatat qui anim laborum fugiat.."}),e.jsx(j,{children:"See More"})]})]})]}),e.jsx(F,{direction:"right",onClick:()=>o("right"),children:e.jsx(G,{})})]})},K=()=>{const i=new q,[n,o]=v.useState(null);return v.useEffect(()=>{i.load("/jordan/scene.gltf",m=>{o(m.scene)})},[]),n?e.jsx("primitive",{object:n,scale:[-.23,.23,-.26],"position-y":-.35,"position-x":0,"rotation-y":0}):null},P=()=>e.jsxs(I,{shadows:!0,frameloop:"demand",dpr:[1,2],gl:{preserveDrawingBuffer:!0},camera:{fov:45,near:1,far:100,position:[-5,3,6]},children:[e.jsx("hemisphereLight",{intensity:2,groundColor:"black"}),e.jsx("spotLight",{position:[900,900,200],angle:.12,penumbra:1,intensity:1,castShadow:!0,"shadow-mapSize":1024}),e.jsx("pointLight",{intensity:1}),e.jsxs(b.Suspense,{fallback:null,children:[e.jsx(B,{autoRotate:!0,enableZoom:!1}),e.jsx(K,{})]})]}),V=t.div`
  ...
  position: relative;
  overflow: hidden;
`;class Z extends v.Component{constructor(n){super(n),this.state={hasError:!1}}static getDerivedStateFromError(n){return{hasError:!0}}render(){return this.state.hasError?e.jsx("h1",{children:"Something went wrong."}):this.props.children}}const Q=t.h1`
  padding: 20px;
  font-size: 70px;
  color: red;
  text-align: center;
...
`,Y=()=>e.jsxs(V,{children:[e.jsx(Q,{children:" Only 3 Left For $120"}),e.jsx(Z,{children:e.jsx(P,{})})]}),_=t.div`
  width: 100%;
  display: flex;
  flex-direction: column; 
  align-items: center; 
...
`,x=t.div`
  ...
  text-align: center;
  display: flex;
`,ie=()=>e.jsxs(_,{children:[e.jsx(ee,{children:" Contact With Us"}),e.jsxs(te,{children:[e.jsx(x,{children:"Email: team28IU@gmail.com"}),e.jsx(x,{children:"Phone Number: (+1) 213 3214 1234"}),e.jsx(x,{children:"Fax: (123)-456-7890"}),e.jsx(x,{children:"Location: 1234 NW Somewhere Lane, St. SKidada, MO 65584-5678"})]})]}),ne="/ecom/assets/waste-6c9150d8.png",re=t.div`
  width: 100%;
  height: 100vh;
  display: flex;
  flex-direction: column; 
